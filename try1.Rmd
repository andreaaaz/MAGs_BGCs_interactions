...
for (col1 in colnames(motus_by_sites)) {
  ...
  for (col2 in colnames(gcfs_by_sites)) {
    ...
    if (all((temp3[[col1]] == 0 & temp3[[col2]] > 0) | (temp3[[col1]] > 0 & temp3[[col2]] == 0) | (temp3[[col1]] == 0 & temp3[[col2]] == 0))) {
