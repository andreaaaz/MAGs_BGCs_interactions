...
for (col1 in colnames(motus_by_sites)) {
  ...
  for (col2 in colnames(gcfs_by_sites)) {
    ...
    temp3[[col1]] <- ifelse(is.na(temp3[[col1]]), 0, temp3[[col1]]) # NAs creados por el join, hay 
    temp3[[col2]] <- ifelse(is.na(temp3[[col2]]), 0, temp3[[col2]]) # estaciones que no estan presentes en la lista de los bgcs
    # ignorar dobles ceros
...
# agregar la n de estaciones guardarlo
