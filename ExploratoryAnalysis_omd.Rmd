...
ggplot(meta_mags, aes(x = depth)) + 
  geom_histogram(bins = 50) + 
  labs(title = "Distribución de profundidades",
       x = "Depth",
       y = "Frecuencia") 
...
ggplot(meta_mags, aes(x = temperature_..C.)) + 
  geom_histogram(bins = 70) + 
  labs(title = "Distribución de profundidades",
       x = "Depth",
       y = "Frecuencia")

ggplot(meta_mags, aes(x = depth, y = temperature_..C.)) +
  geom_point(alpha = 0.6) +
  labs(title = "Profundidad vs Temperatura",
       x = "Depth",
       y = "Temperature")
